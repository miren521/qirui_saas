...
ADD INDEX IDX_ns_wholesale_goods_cart_member_id (member_id);
...
--
ALTER TABLE supply_goods_sku
ADD INDEX IDX_supply_goods_category_id_1 (category_id_1);

--
--
ALTER TABLE supply_goods_sku
ADD INDEX IDX_supply_goods_category_id_2 (category_id_2);

--
--
ALTER TABLE supply_goods_sku
ADD INDEX IDX_supply_goods_category_id_3 (category_id_3);
...
--
ALTER TABLE servicer_dialogue
ADD INDEX index_member_id (member_id) COMMENT '聊天会员ID索引';
...
ADD INDEX IDX_ns_goods_brand_id (brand_id);
...
--
ALTER TABLE goods_sku
ADD INDEX IDX_ns_goods_category_id_1 (category_id_1);

--
--
ALTER TABLE goods_sku
ADD INDEX IDX_ns_goods_category_id_2 (category_id_2);

--
--
ALTER TABLE goods_sku
ADD INDEX IDX_ns_goods_category_id_3 (category_id_3);
...
--
ALTER TABLE goods_sku
ADD INDEX IDX_ns_goods_is_own_shop (is_own);
...
--
ALTER TABLE goods_sku
ADD INDEX IDX_ns_goods_website_id (website_id);
