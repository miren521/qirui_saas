...
class Shop extends BaseCity
{
    ...
    public function addShop()
    {
        if (request()->isAjax()) {
            ...
            return $this->fetch('shop/add_shop',[],$this->replace);
        }
    }
    ...
    public function settlementInfo()
    {
        ...
        if (request()->isAjax()) {
            ...
            if($cert_data['bank_type'] == 1){
                ...
                $cert_data['settlement_bank_account_name'] = input('settlement_zfb_account_name', 0);//结算银行开户名
                $cert_data['settlement_bank_account_number'] = input('settlement_zfb_account_number', 0);//结算公司银行账号
            }
