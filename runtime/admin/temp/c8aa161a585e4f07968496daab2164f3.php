<?php /*a:1:{s:54:"./addon/wholesale/component/view/wholesale/design.html";i:1600312146;}*/ ?>
<nc-component v-bind:data="data[index]" class="component-wholesale" v-bind:style="{backgroundColor: nc.backgroundColor}">
			...
			<div class="item">
				...
				<div class="info-wrap">
					...
					<div class="price-wrap">
						<span class="old-price">已售25件</span>
						<span class="new-price ns-text-color">批发价:￥998.00</span>
					</div>
				</div>
