<?php /*a:2:{s:61:"/www/wwwroot/saas.goodsceo.com/app/admin/view/stat/index.html";i:1600312146;s:55:"/www/wwwroot/saas.goodsceo.com/app/admin/view/base.html";i:1600312146;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-card ns-card-common ns-card-brief">
	...
	<div class="layui-card-body ns-basic">
		<div class="ns-table-tuwen-box">
			<div class="ns-img-box">
				<img src="http://saas.goodsceo.com/app/admin/view/public/img/stat/goods_browse.png">
			</div>
		...
		<div class="ns-table-tuwen-box">
			<div class="ns-img-box">
				<img src="http://saas.goodsceo.com/app/admin/view/public/img/stat/goods_collect.png">
			</div>
			<div class="ns-font-box">
		...
		<div class="ns-table-tuwen-box">
			<div class="ns-img-box">
				<img src="http://saas.goodsceo.com/app/admin/view/public/img/stat/goods_order.png">
			</div>
			<div class="ns-font-box">
        ...
        <div class="ns-table-tuwen-box">
            <div class="ns-img-box">
                <img src="http://saas.goodsceo.com/app/admin/view/public/img/stat/shop_collect.png">
            </div>
            <div class="ns-font-box">
    ...
    <div class="layui-card-body ns-basic">
        <div class="ns-table-tuwen-box">
            <div class="ns-img-box">
                <img src="http://saas.goodsceo.com/app/admin/view/public/img/stat/order_money.png">
            </div>
            <div class="ns-font-box">
				<div class="ns-text-color-dark-gray ns-prompt-block">
					订单金额&nbsp;&nbsp;
        ...
        <div class="ns-table-tuwen-box">
            <div class="ns-img-box">
                <img src="http://saas.goodsceo.com/app/admin/view/public/img/stat/order_num.png">
            </div>
            <div class="ns-font-box">
        ...
        <div class="ns-table-tuwen-box">
            <div class="ns-img-box">
                <img src="http://saas.goodsceo.com/app/admin/view/public/img/stat/member_num.png">
            </div>
            <div class="ns-font-box">
				<div class="ns-text-color-dark-gray ns-prompt-block">
					会员人数&nbsp;&nbsp;
