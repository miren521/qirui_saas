<?php /*a:2:{s:55:"/www/wwwroot/city.lpstx.cn/app/admin/view/pc/floor.html";i:1600312146;s:51:"/www/wwwroot/city.lpstx.cn/app/admin/view/base.html";i:1600312146;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script>
    ...
    layui.use('form', function() {
        ...
        table.tool(function(obj) {
            ...
            switch (obj.event) {
                case 'edit': //编辑
                    location.href = ns.url("admin/pc/editfloor?id=" + data.id);
                    break;
                case 'delete': //删除
                    deleteFloor(data.id);
                    break;
    ...
    function deleteFloor(id) {
        ...
        layer.confirm('确定要删除该首页楼层吗?', function () {
                $.ajax({
                    url: ns.url("admin/pc/deletefloor"),
                    data: {id: id},
                    dataType: 'JSON',
                    type: 'POST',
                    success: function (res) {
    ...
    function editSort(id, event) {
        ...
        $.ajax({
            type: 'POST',
            url: ns.url("admin/pc/modifyFloorSort"),
            data: {
                sort: data,
                id: id
            },
    ...
    function add() {
        location.href = ns.url("admin/pc/editfloor");
    }
</script>
