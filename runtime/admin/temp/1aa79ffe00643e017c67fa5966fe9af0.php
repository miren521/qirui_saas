<?php /*a:2:{s:58:"/www/wwwroot/city.lpstx.cn/app/admin/view/system/auth.html";i:1600314240;s:51:"/www/wwwroot/city.lpstx.cn/app/admin/view/base.html";i:1600312146;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="layui-body<?php if(empty($second_menu) || (($second_menu instanceof \think\Collection || $second_menu instanceof \think\Paginator ) && $second_menu->isEmpty())): ?> child_no_exit<?php endif; ?>">
		...
		<div class="ns-body-content <?php if(count($second_menu) < 1): ?> crumbs_no_exit<?php endif; ?>">
			<div class="ns-body">
				...
				<?php endif; if(!is_null($auth_info) && $auth_info['code'] == 0): ?>
<div class="layui-form ns-form">
    <div class="layui-form-item">
        <label class="layui-form-label">授权状态：</label>
        <div class="layui-input-block">
            <p class="ns-input-text ns-len-mid">已授权</p>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <p class="ns-input-text ns-len-mid"><?php echo !empty($auth_info['data']['product_name']) ? htmlentities($auth_info['data']['product_name']) : '--'; ?></p>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <p class="ns-input-text ns-len-mid"><?php echo !empty($auth_info['data']['devolution_version_name']) ? htmlentities($auth_info['data']['devolution_version_name']) : '--'; ?></p>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <p class="ns-input-text ns-len-mid"><?php echo !empty($auth_info['data']['devolution_url']) ? htmlentities($auth_info['data']['devolution_url']) : '--'; ?></p>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <p class="ns-input-text ns-len-mid"><?php echo date('Y-m-d H:i:s', $auth_info['data']['devolution_date']); ?></p>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <p class="ns-input-text">V<?php echo !empty($app_info['version']) ? htmlentities($app_info['version']) : '--'; ?></p>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <p class="ns-input-text">V<?php echo !empty($auth_info['data']['newest_version']) ? htmlentities($auth_info['data']['newest_version']) : '--'; ?></p>
        </div>
    </div>
</div>
<?php else: ?>
<div class="layui-form ns-form">
    <div class="layui-form-item">
        <label class="layui-form-label">授权状态：</label>
        <div class="layui-input-block">
            <p class="ns-input-text ns-len-mid">未授权</p>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">授权产品：</label>
        <div class="layui-input-block">
            <p class="ns-input-text ns-len-mid">--</p>
        </div>
    </div>
