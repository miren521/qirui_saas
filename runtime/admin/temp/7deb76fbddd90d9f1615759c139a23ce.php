<?php /*a:2:{s:59:"/www/wwwroot/city.lpstx.cn/app/admin/view/refund/lists.html";i:1600312146;s:51:"/www/wwwroot/city.lpstx.cn/app/admin/view/base.html";i:1600312146;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script src="http://city.lpstx.cn/app/admin/view/public/js/refund_list.js"></script>
<script>
    ...
    layui.use(['laypage','laydate','form', 'element'], function(){
        ...
        form.on('submit(batch_export)', function(data){
            ...
            location.href = ns.url("admin/order/exportRefundOrder",data.field);
            return false;
        });
