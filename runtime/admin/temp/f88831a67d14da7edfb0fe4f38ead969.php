<?php /*a:2:{s:62:"/www/wwwroot/saas.goodsceo.com/app/admin/view/login/login.html";i:1600312146;s:55:"/www/wwwroot/saas.goodsceo.com/app/admin/view/base.html";i:1600312146;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<link rel="stylesheet" type="text/css" href="http://saas.goodsceo.com/app/admin/view/public/css/login.css" />
...
<div class="layui-container">
	<div class="layui-form login-form">
		<div class="ns-login-logo">
			<img src="http://saas.goodsceo.com/app/admin/view/public/img/login/login_logo.png" />
		</div>
		...
		<div class="layui-form-item">
			<img class="ns-input-icon" src="http://saas.goodsceo.com/app/admin/view/public/img/login/username.png" />
			<input type="text" name="username" lay-verify="userName" placeholder="请输入用户名" autocomplete="off" class="layui-input">
		</div>
		<div class="layui-form-item">
			<img class="ns-input-icon" src="http://saas.goodsceo.com/app/admin/view/public/img/login/password.png" />
