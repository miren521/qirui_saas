<?php /*a:2:{s:63:"/www/wwwroot/city.lpstx.cn/app/admin/view/config/aftersale.html";i:1600312146;s:51:"/www/wwwroot/city.lpstx.cn/app/admin/view/base.html";i:1600312146;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form ns-form">
	...
	<input type="hidden" name="content" id="setContent" value="<?php echo htmlentities($content['data']['content']); ?>" />
</div>
...
<script type="text/javascript" charset="utf-8" src="http://city.lpstx.cn/public/static/ext/ueditor/ueditor.config.js"></script>
<script type="text/javascript" charset="utf-8" src="http://city.lpstx.cn/public/static/ext/ueditor/ueditor.all.js"></script>
<script type="text/javascript" charset="utf-8" src="http://city.lpstx.cn/public/static/ext/ueditor/lang/zh-cn/zh-cn.js"></script>
<script>
	...
	layui.use('form', function() {
		...
		form.on('submit(save)', function(data) {
			...
			$.ajax({
				url: ns.url("admin/config/aftersale"),
				data: data.field,
				dataType: 'JSON',
				type: 'POST',
				success: function(res) {
