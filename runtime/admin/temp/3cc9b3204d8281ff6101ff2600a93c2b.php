<?php /*a:2:{s:66:"/www/wwwroot/city.lpstx.cn/app/admin/view/pc/hot_search_words.html";i:1600314240;s:51:"/www/wwwroot/city.lpstx.cn/app/admin/view/base.html";i:1600312146;}*/ ?>
<!DOCTYPE html>
<html>
<head>
		...
		<div class="layui-card-body">
			<div class="layui-form-item">
				...
				<div class="layui-input-block keywords-block">
					<?php if(!empty($hot_search_words['words_array'])): foreach($hot_search_words['words_array'] as $k => $v): ?>
					<div class="layui-input-inline keywords-item">
						<input type="text" name="words[]" lay-verify="required" value="<?php echo htmlentities($v); ?>" placeholder=""
							   autocomplete="off" class="layui-input ns-len-short">
						<i class="layui-icon layui-icon-close" ></i>
					</div>
					<?php endforeach; else: ?>
					<div class="layui-input-inline keywords-item">
						<input type="text" name="words[]" lay-verify="required" value="" placeholder=""
							   autocomplete="off" class="layui-input ns-len-short">
						<i class="layui-icon layui-icon-close" ></i>
					</div>
					<?php endif; ?>
...
<script src="http://city.lpstx.cn/public/static/ext/drag-arrange.js"></script>
<script>
	layui.use('form', function() {
		...
		form.on('submit(save)', function(data) {
			...
			$.ajax({
				url: ns.url("admin/pc/hotsearchwords"),
				data: data.field,
				dataType: 'JSON',
				type: 'POST',
				success: function(res) {
