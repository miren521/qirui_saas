<?php /*a:2:{s:61:"/www/wwwroot/city.lpstx.cn/app/admin/view/pc/float_layer.html";i:1600312146;s:51:"/www/wwwroot/city.lpstx.cn/app/admin/view/base.html";i:1600312146;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form ns-form">
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input name="title" type="text" lay-verify="required" class="layui-input ns-len-mid" <?php if($float_layer): ?> value="<?php echo htmlentities($float_layer['title']); ?>" <?php endif; ?>>
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block ns-len-mid">
			<select name="link" lay-filter="link">
				...
				<option value="<?php echo htmlentities($v['url']); ?>" <?php if($float_layer && $float_layer['url'] && json_decode($float_layer['url'],true)['title'] == $v['title']): ?>selected<?php endif; ?>><?php echo htmlentities($v['title']); ?></option>
				<?php endforeach; ?>
				<option value="diy" <?php if($float_layer && $float_layer['url'] && json_decode($float_layer['url'],true)['title'] == '自定义'): ?>selected<?php endif; ?>>自定义</option>
			</select>
			<input name="url" type="hidden" <?php if($float_layer): ?> value="<?php echo htmlentities($float_layer['url']); ?>" <?php endif; ?>>
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="checkbox" name="is_show" value="1" lay-skin="switch" <?php if($float_layer && $float_layer['is_show'] == 1): ?> checked <?php endif; ?> />
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input name="number" type="text" lay-verify="required" class="layui-input ns-len-short" <?php if($float_layer): ?> value="<?php echo htmlentities($float_layer['number']); ?>" <?php endif; ?>>
		</div>
	</div>

	<div class="layui-form-item">
		<label class="layui-form-label">浮窗图片：</label>
		<input type="hidden" name="img_url" <?php if($float_layer): ?> value="<?php echo htmlentities($float_layer['img_url']); ?>" <?php endif; ?>>
		<div class="layui-input-inline">
			<div class="upload-img-block">
				<div class="upload-img-box" id="imgUpload">
					<?php if(empty($float_layer['img_url'])): ?>
					<div class="ns-upload-default">
						<img src="http://city.lpstx.cn/public/static/img/upload_img.png" />
						<p>点击上传</p>
					</div>
					<?php else: ?>
					<img src="<?php echo img($float_layer['img_url']); ?>" alt="">
					<?php endif; ?>
				</div>
			</div>
		</div>
