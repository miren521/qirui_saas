<?php /*a:2:{s:77:"/www/wwwroot/saas.goodsceo.com/addon/goodscircle/admin/view/config/index.html";i:1600314240;s:24:"app/admin/view/base.html";i:1600312146;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form">
	<div class="layui-card ns-card-common">
		<div class="layui-card-header">
			...
			<input type="checkbox" name="isUse" lay-skin="switch" <?php if($config['is_use'] == 1): ?> checked <?php endif; ?>  lay-filter="isUse"/>
		</div>
	...
	<div class="ns-wechat-wrap">
		<!-- <div class="ns-wechat-circle-wrap">
			...
			<div class="ns-wechat-circle-img">
				<img src="http://saas.goodsceo.com/addon/goodscircle/admin/view/public/img/1.png" />
			</div>
		</div> -->
		...
		<div class="ns-wechat-circle-wrap">
			<div class="ns-wechat-circle-img">
				<img src="http://saas.goodsceo.com/addon/goodscircle/admin/view/public/img/2.png" />
			</div>
			<div class="ns-wechat-circle-intro">
				<h1>搜索商品</h1>
