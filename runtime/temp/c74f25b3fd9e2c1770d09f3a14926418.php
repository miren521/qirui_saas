<?php /*a:2:{s:71:"/www/wwwroot/saas.goodsceo.com/addon/city/admin/view/website/lists.html";i:1600312146;s:24:"app/admin/view/base.html";i:1600312146;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script type="text/html" id="website_info">
    <div class="ns-table-tuwen-box">
        <div class="ns-img-box">
			...
			{{#  }else{  }}
			<img layer-src src="http://saas.goodsceo.com/public/static/img/default_shop.png" />
            {{#  }  }}
        </div>
