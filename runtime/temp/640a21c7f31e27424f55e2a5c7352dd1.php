<?php /*a:2:{s:74:"/www/wwwroot/saas.goodsceo.com/addon/supply/admin/view/supplier/index.html";i:1600312146;s:24:"app/admin/view/base.html";i:1600312146;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-collapse ns-tips">
    <div class="layui-colla-item">
        ...
        <ul class="layui-colla-content layui-show">
			...
			<li>供应商管理中心：<a href="<?php echo url('supply/supply/index/index'); ?>" target="_blank" style="color: orangered">
                <?php echo url('supply/supply/index/index'); ?></a></li>
			<li>供应市场：<a href="<?php echo url('supply/shop/market/index'); ?>" target="_blank" style="color: orangered">
                <?php echo url('supply/shop/market/index'); ?></a></li>
        </ul>
    </div>
</div>
...
<script>
    ...
    layui.use(['table', 'form'], function() {
        ...
        table.tool(function(obj) {
            ...
            switch (obj.event) {
                case 'edit':
                    location.href = ns.url("supply://admin/supplier/edit", {supplier_id: data.supplier_id});
                    break;
                case 'delete':
