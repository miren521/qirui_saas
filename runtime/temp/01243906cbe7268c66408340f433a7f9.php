<?php /*a:2:{s:73:"E:\mi\company\SaaS\code\back-end\addon\city\admin\view\website\lists.html";i:1600312146;s:24:"app/admin/view/base.html";i:1600312146;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script type="text/html" id="website_info">
    <div class="ns-table-tuwen-box">
        <div class="ns-img-box">
			...
			{{#  }else{  }}
			<img layer-src src="http://saas.com/public/static/img/default_shop.png" />
            {{#  }  }}
        </div>
...
<script>
    ...
    layui.use(['element','laydate','form', 'laytpl','upload'], function () {
        var element = layui.element,
                ...
                <div class="upload-img-block">
                    ...
                    <div class="upload-img-box" id="paying_money_certificate">
                        <div class="ns-upload-default">
                            <img src="http://saas.com/public/static/img/upload_img.png" />
                            <p>点击上传</p>
                        </div>
                    </div>
                </div>
