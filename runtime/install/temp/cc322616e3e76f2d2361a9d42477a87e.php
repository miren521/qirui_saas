<?php /*a:2:{s:65:"/www/wwwroot/saas.goodsceo.com/app/install/view/index/step-4.html";i:1600314240;s:57:"/www/wwwroot/saas.goodsceo.com/app/install/view/base.html";i:1600314240;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<style>
	...
	.install-content-procedure .content-procedure-item:nth-child(4){
		background: url("http://saas.goodsceo.com/app/install/view/public/img/complete_three.png") no-repeat center / contain;
		color: #fff;
	}
...
<div class="install-success">
	<div class="install-success-box">
		<img class="install-success-pic" src="http://saas.goodsceo.com/app/install/view/public/img/install_complete.png" alt="">
	...
	<ul class="other-links-list">
		<li class="other-links-item">
			<div  class="other-links-pic">
				<img src="http://saas.goodsceo.com/app/install/view/public/img/site_backstage.png" alt="">
			</div>
			<a href="<?php echo htmlentities($root_url); ?>/index.php/admin" class="other-links-text" target="_blank">网站后台</a>
		</li>
		<li class="other-links-item">
			<div  class="other-links-pic">
				<img src="http://saas.goodsceo.com/app/install/view/public/img/site_index.png" alt="">
			</div>
			<a href="<?php echo htmlentities($root_url); ?>/index.php/shop" class="other-links-text" target="_blank">店铺后台</a>
		</li>
		<li class="other-links-item">
			<div  class="other-links-pic">
				<img src="http://saas.goodsceo.com/app/install/view/public/img/official_website.png" alt="">
			</div>
			<a href="https://www.niushop.com" class="other-links-text" target="_blank">NIUSHOP官方网站</a>
		</li>
		<li class="other-links-item">
			<div  class="other-links-pic">
				<img src="http://saas.goodsceo.com/app/install/view/public/img/forum.png" alt="">
			</div>
