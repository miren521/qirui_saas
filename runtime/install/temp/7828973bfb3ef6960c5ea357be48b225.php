<?php /*a:2:{s:65:"/www/wwwroot/saas.goodsceo.com/app/install/view/index/step-2.html";i:1600312146;s:57:"/www/wwwroot/saas.goodsceo.com/app/install/view/base.html";i:1600314240;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="testing-item">
		...
		<table  border="0" align="center" cellpadding="0" cellspacing="0" class="twbox">
			...
			<tr>
				...
				<td><img clsss="check-icon" src="<?php if($variables_item['status']): ?>http://saas.goodsceo.com/app/install/view/public/img/success.png<?php else: ?>http://saas.goodsceo.com/app/install/view/public/img/error.png<?php endif; ?>"/></td>
			</tr>
			<?php endforeach; ?>
		</table>
	</div>
	...
	<div class="testing-item">
		...
		<table border="0" align="center" cellpadding="0" cellspacing="0" class="twbox">
			...
			<tr>
				...
				<td>
					<img clsss="check-icon" src="<?php if($dirs_item['is_readable']): ?>http://saas.goodsceo.com/app/install/view/public/img/success.png<?php else: ?>http://saas.goodsceo.com/app/install/view/public/img/error.png<?php endif; ?>"/>
				</td>
				<td>
					<img clsss="check-icon" src="<?php if($dirs_item['is_write']): ?>http://saas.goodsceo.com/app/install/view/public/img/success.png<?php else: ?>http://saas.goodsceo.com/app/install/view/public/img/error.png<?php endif; ?>"/>
				</td>
			</tr>
			<?php endforeach; ?>
