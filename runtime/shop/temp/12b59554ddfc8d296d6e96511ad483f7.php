<?php /*a:2:{s:57:"/www/wwwroot/city.lpstx.cn/app/shop/view/login/login.html";i:1600312148;s:50:"/www/wwwroot/city.lpstx.cn/app/shop/view/base.html";i:1600314240;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	...
	<link rel="icon" type="image/x-icon" href="http://jl.lpstx.cn/public/static/img/shop_bitbug_favicon.ico" />
	<link rel="stylesheet" type="text/css" href="http://jl.lpstx.cn/public/static/css/iconfont.css" />
	<link rel="stylesheet" type="text/css" href="http://jl.lpstx.cn/public/static/ext/layui/css/layui.css" />
	<link rel="stylesheet" type="text/css" href="http://jl.lpstx.cn/app/shop/view/public/css/common.css" />
	<script src="http://jl.lpstx.cn/public/static/js/jquery-3.1.1.js"></script>
	<script src="http://jl.lpstx.cn/public/static/ext/layui/layui.js"></script>
	<script src="https://cdn.jsdelivr.net/npm/js-cookie@2/src/js.cookie.min.js"></script>
	<script>
		layui.use(['layer', 'upload', 'element'], function() {});
		
		window.ns_url = {
			baseUrl: "http://jl.lpstx.cn/",
			route: ['<?php echo request()->module(); ?>', '<?php echo request()->controller(); ?>', '<?php echo request()->action(); ?>'],
		};
	</script>
	<script src="http://jl.lpstx.cn/public/static/js/common.js"></script>
	<script src="http://jl.lpstx.cn/app/shop/view/public/js/common.js"></script>
	<style>
		.ns-calendar{background: url("http://jl.lpstx.cn/public/static/img/ns_calendar.png") no-repeat center / 16px 16px;}
		.layui-logo{height: 100%;display: flex;align-items: center;}
		.layui-logo a{display: flex;justify-content: center;align-items: center;width: 200px;height: 50px;}
		.layui-logo a img{max-height: 100%;max-width: 100%;}
	</style>
	
<link rel="stylesheet" href="http://jl.lpstx.cn/app/shop/view/public/css/login.css">
<style>
	/* .login-body{background-image: url("<?php echo img('http://jl.lpstx.cn/app/shop/view/public/img/login/login_bg.png'); ?>"); background-size: cover;} */
</style>
		...
		<div class="apply-header-box">
			<div class="apply-header-title">
				<a href="<?php echo url('shop/index/index'); ?>">
					...
					<?php else: ?>
					<img src="http://jl.lpstx.cn/app/shop/view/public/img/shop_logo.png">
					<?php endif; ?>
...
<!--		<h3>登录之后可进入店铺或申请入驻</h3>-->
		<div class="layui-form">
			<div class="login-input login-info">
				<div class="login-icon">
					<img src="http://jl.lpstx.cn/app/shop/view/public/img/login/login_username.png" alt="">
				</div>
				<input type="text" name="username" lay-verify="userName" placeholder="请输入用户名" autocomplete="off" class="layui-input">
			</div>
			<div class="login-input login-info">
				<div class="login-icon">
					<img src="http://jl.lpstx.cn/app/shop/view/public/img/login/login_password.png" alt="">
				</div>
	...
	<div class="ns-login-bottom">
		<a class="ns-footer-img" href="#"><img src="<?php if(!empty($copyright['logo'])): ?> <?php echo img($copyright['logo']); else: ?>http://jl.lpstx.cn/public/static/img/copyright_logo.png<?php endif; ?>" /></a>
