<?php /*a:2:{s:63:"E:\mi\company\SaaS\code\back-end\app\shop\view\login\login.html";i:1600312148;s:56:"E:\mi\company\SaaS\code\back-end\app\shop\view\base.html";i:1600314240;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	...
	<link rel="icon" type="image/x-icon" href="http://saas.com/public/static/img/shop_bitbug_favicon.ico" />
	...
	<link rel="stylesheet" type="text/css" href="http://saas.com/app/shop/view/public/css/common.css" />
	...
	<script>
		...
		window.ns_url = {
			baseUrl: "http://saas.com/index.php/",
			route: ['<?php echo request()->module(); ?>', '<?php echo request()->controller(); ?>', '<?php echo request()->action(); ?>'],
		};
	</script>
	<script src="http://saas.com/public/static/js/common.js"></script>
	<script src="http://saas.com/app/shop/view/public/js/common.js"></script>
	<style>
...
<link rel="stylesheet" href="http://saas.com/app/shop/view/public/css/login.css">
<style>
	/* .login-body{background-image: url("<?php echo img('http://saas.com/app/shop/view/public/img/login/login_bg.png'); ?>"); background-size: cover;} */
</style>
		...
		<div class="apply-header-box">
			<div class="apply-header-title">
				<a href="<?php echo url('shop/index/index'); ?>">
					...
					<?php else: ?>
					<img src="http://saas.com/app/shop/view/public/img/shop_logo.png">
					<?php endif; ?>
...
<!--		<h3>登录之后可进入店铺或申请入驻</h3>-->
		<div class="layui-form">
			<div class="login-input login-info">
				<div class="login-icon">
					<img src="http://saas.com/app/shop/view/public/img/login/login_username.png" alt="">
				</div>
				<input type="text" name="username" lay-verify="userName" placeholder="请输入用户名" autocomplete="off" class="layui-input">
			</div>
			<div class="login-input login-info">
				<div class="login-icon">
					<img src="http://saas.com/app/shop/view/public/img/login/login_password.png" alt="">
				</div>
	...
	<div class="ns-login-bottom">
		<a class="ns-footer-img" href="#"><img src="<?php if(!empty($copyright['logo'])): ?> <?php echo img($copyright['logo']); else: ?>http://saas.com/public/static/img/copyright_logo.png<?php endif; ?>" /></a>
